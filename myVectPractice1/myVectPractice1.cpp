// Derrik Pollock - this program is for practice with using 
...
int main()
{
	...
	// Now remove another value from the function
	cout << "Popping another value from the vector...\n";
	values.pop_back();
	cout << "The size of values is now: " << values.size() << endl;


	// Remove the last value from the vector
	cout << "Popping the last value from the vector...\n";
	values.pop_back();
	cout << "The size of values is now: " << values.size() << endl;
	return 0;
}